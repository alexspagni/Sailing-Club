...
/**
 * The {@code StaffSeeStoragePaymentController} class is used to show to a Staff
 * member a table where he see all storage payment made with credit card or
 * bonifico.
 * 
 * @author Spagni Alex Zuelli Arianna
 * 
 */
public class StaffSeeStoragePaymentController implements Initializable {
//	private static final Constant constant = new Constant();
	private FeeStaffEnum racePayment=FeeStaffEnum.GET_ALL_STORAGE_PAYMENT;
