...
/**
 * The {@code StaffSeeMembershipPaymentController} class is used to show to a
 * Staff member a table where he see all membership payment made with credit
 * card or bonifico.
 * 
 * @author Spagni Alex Zuelli Arianna
 * 
 */
public class StaffSeeMembershipPaymentController implements Initializable {
	private FeeStaffEnum membershipPayment=FeeStaffEnum.GET_ALL_MEMBERSHIP_PAYMENT;
