...
/**
 * The {@code ResponseStaffRace} class is a Response class and it used to send a response from the server to the client.
 * This Response class is used to send this kind of request:
 * 1)Send an array list that contains all race drawn from the server<br>
 * 2)Send an integer value, that means if an operation produced a positive result or not<br>
 * @author Spagni Alex Zuelli Arianna
 * 
 */
public class ResponseStaffRace implements Serializable {
	 ...
	 * @param race array list that contains all race drawn from the server.
	 */
	public ResponseStaffRace(int ris,ArrayList<Race>race) {
		this.ris=ris;
		this.race=race;
	 ...
	 * @param ris  an integer value that means if an operation produced a positive result or not.
	 */
	public ResponseStaffRace(int ris) {
		this.ris=ris;
